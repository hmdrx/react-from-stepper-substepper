...
const subStepperList = [4, 2, 3]; // number of sub-stepper you need respect to main stepper
...
| SaveAsDraftButton                                    | (saveAsDraft: () => void) => React.JSX.Element |                                                                                                                                                       | A function returning a JSX element for the Save as Draft button                  |
